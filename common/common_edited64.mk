...
# Linker script
LD_SCRIPT ?= $(NEORV32_COM_PATH)/neorv32_edited64.ld
...
CC_OPTS  = -march=$(MARCH) -mabi=$(MABI) $(EFFORT) -Wall -ffunction-sections -fdata-sections -nostartfiles -mno-fdiv -mcmodel=medany
